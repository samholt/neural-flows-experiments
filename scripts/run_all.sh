...
# Sine
# python -m nfe.train --seed 1 --experiment synthetic --data sine --epochs 1000 --batch-size 50 --weight-decay 1e-05 --model ode --odenet concat --solver euler --hidden-layers 3 --hidden-dim 64 --activation ELU --final-activation Tanh
# python -m nfe.train --seed 1 --experiment synthetic --data sine --epochs 1000 --batch-size 50 --weight-decay 1e-05 --model flow --flow-model coupling --flow-layers 4 --time-net TimeFourier --time-hidden-dim 8 --hidden-layers 2 --hidden-dim 64 --activation ReLU --final-activation Identity
# python -m nfe.train --seed 1 --experiment synthetic --data sine --epochs 1000 --batch-size 50 --weight-decay 1e-05 --model flow --flow-model resnet --flow-layers 4 --time-net TimeFourierBounded --time-hidden-dim 8 --hidden-layers 2 --hidden-dim 64 --activation ReLU --final-activation Identity
...
# Sine
# python -m nfe.train --seed 1 --experiment latent_ode --batch-size 100 --epochs 1000 --lr-decay 0.5 --lr-scheduler-step 20 --weight-decay 0.0001 --extrap 0 --classify 0 --data sine --hidden-layers 3 --hidden-dim 100 --rec-dims 100 --latents 20 --gru-units 50 --model ode --odenet concat --solver euler

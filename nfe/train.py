...
parser.add_argument('--lr-scheduler-step', type=int, default=-1,
...
parser.add_argument('--final-activation', type=str,
                    default='Identity', help='Last layer activation')
...
# Flow model args
parser.add_argument('--flow-model', type=str, default='coupling',
                    help='Model name', choices=['coupling', 'resnet', 'gru'])
parser.add_argument('--flow-layers', type=int, default=1,
                    help='Number of flow layers')
parser.add_argument('--time-net', type=str, default='TimeLinear', help='Name of time net',
                    choices=['TimeFourier', 'TimeFourierBounded', 'TimeLinear', 'TimeTanh'])
parser.add_argument('--time-hidden-dim', type=int, default=1,
                    help='Number of time features (only for Fourier)')

# latent_ode specific args
parser.add_argument('--classify', type=int, default=0,
                    help='Include classification loss (physionet and activity)', choices=[0, 1])
parser.add_argument('--extrap', type=int, default=0,
                    help='Set extrapolation mode. Else run interpolation mode.', choices=[0, 1])
parser.add_argument('-n', type=int, default=10000,
                    help='Size of the dataset (latent_ode)')
...
parser.add_argument('--gru-units', type=int, default=100,
...
parser.add_argument('--decoder', type=str, default='continuous',
                    help='Intensity function', choices=['continuous', 'mixture'])
parser.add_argument('--rnn', type=str, help='RNN encoder',
                    choices=['gru', 'lstm'])
parser.add_argument('--marks', type=int, default=0,
                    help='Whether to use marked TPP', choices=[0, 1])

# STPP args
parser.add_argument('--density-model', type=str, help='Type of density model',
